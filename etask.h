...
/*
 * Return 0 on success, or -1 if efd has been made nonblocking and errno is EAGAIN.
 * If efd has been marked blocking or the eventfd counter is not zero, this function doesn't return error.
 */
